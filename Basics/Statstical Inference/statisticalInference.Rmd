...
consider the null hypothesis that the group label is unrelated to the  outcome. 
...
```  
Hence we are able to reject the null that the group labels have no effect on the 
outcome.

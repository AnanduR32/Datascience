...
top_bigrams = bi_token_df %>%
  filter(freq > 1)
write.csv(data.frame(top_bigrams), "../NGrams/top_bigrams.csv", fileEncoding = 'UTF-8')
```
...
write.csv(data.frame(top_trigrams), "../NGrams/top_trigrams.csv")
```
...
write.csv(data.frame(top_tetragrams), "../NGrams/top_tetragrams.csv")
```

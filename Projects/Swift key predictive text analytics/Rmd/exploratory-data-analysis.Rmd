...
clean_corpus <- function (corpus) {
    ...
    corpus <- tm_map(corpus, replace_number) # Eliminate numbers
...
predictWord = function(str){
  ...
  if(n_words == 3){
    matching_tetragrams<-grepl(str, top_tetragrams[,1], ignore.case=TRUE)
    matching_trigrams<-grep(str, top_trigrams[,1], ignore.case=TRUE)
    matching_bigrams<-grep(str, top_bigrams[,1], ignore.case=TRUE)
  }
}
```
